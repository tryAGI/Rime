...
internal static class CliRuntime
{
    ...
    public static async Task<global::Rime.RimeClient> CreateClientAsync(ParseResult parseResult, CancellationToken cancellationToken = default)
    {
    ...
    private static async Task WriteApiExceptionAsync(global::Rime.ApiException exception)
    {
        var builder = new StringBuilder();
