...
{
    private const string UserSecretsId = "Rime.CLI";
    private const string UserSecretApiKeyName = "RIME_API_KEY";
    private static readonly string[] ApiKeyEnvironmentVariables = [@"RIME_API_KEY"];
    private const string CredentialFileDirectoryName = ".rime";

    public static async global::System.Threading.Tasks.Task<global::Rime.RimeClient> CreateClientAsync(ParseResult parseResult, CancellationToken cancellationToken = default)
    {
        ...
        var authorizations = string.IsNullOrWhiteSpace(apiKey)
            ? new global::System.Collections.Generic.List<global::Rime.EndPointAuthorization>()
            : new global::System.Collections.Generic.List<global::Rime.EndPointAuthorization>
            {
        CreateAuthorization(
            type: "Http",
        ...
        return new global::Rime.RimeClient(
            httpClient: null,
            baseUri: baseUri,
    ...
    private static global::Rime.EndPointAuthorization CreateAuthorization(
        string type,
        string schemeId,
        string location,
        string name,
        string value)
    {
        var authorization = new global::Rime.EndPointAuthorization
        {
            Type = type,
            Location = location,
            Name = name,
        ...
        var schemeIdProperty = typeof(global::Rime.EndPointAuthorization).GetProperty("SchemeId");
    ...
    public static async global::System.Threading.Tasks.Task<int> RunAsync(Func<global::System.Threading.Tasks.Task> action, CancellationToken cancellationToken = default)
    {
        ...
        catch (global::Rime.ApiException exception)
        {
    ...
    private static Uri? ResolveBaseUri(ParseResult parseResult)
    {
        ...
        {
            baseUrl = Environment.GetEnvironmentVariable("RIME_BASE_URL");
        }
    ...
    private static async global::System.Threading.Tasks.Task WriteApiExceptionAsync(global::Rime.ApiException exception)
    {
        var builder = new StringBuilder();
